...
static void dma_cfg(void){
    ...
    dma_parameter_struct d = {0}; 
		//d.number=ADC_DMA_BUFFER_COUNT;  // ÿ DMA ѭҪ 6 Ӧ 6 ͨĽ,˫
    d.number=ADC_DMA_BUFFER_COUNT;  // ˫ÿ DMA ѭ 6*2=12 ǰ 6 ڰ봫䣨HTF 6 ȫ䣨FTF˫崦
    adc_channel_length_config(ADC0, ADC_REGULAR_CHANNEL, ADC_MULTI_CHANNEL_COUNT);  //  ADC ĳͨ
