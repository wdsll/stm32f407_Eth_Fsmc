...
static const Platform_SystemIrqConfigType aSysIrqCfg[] = {
    { FPU_INPUT_DENORMAL_IRQ, TRUE },
    { FPU_INEXACT_IRQ, TRUE },
    { FPU_UNDERFLOW_IRQ, TRUE },
    { FPU_OVERFLOW_IRQ, TRUE },
    { FPU_DIVIDE_BY_ZERO_IRQ, TRUE },
};
