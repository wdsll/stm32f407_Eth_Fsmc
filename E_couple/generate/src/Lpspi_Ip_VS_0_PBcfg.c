...
const Lpspi_Ip_ExternalDeviceType Lpspi_Ip_DeviceAttributes_SpiExternalDevice_0_Instance_0_VS_0 =
{
    ...
    (uint32)(LPSPI_CFGR0_HRDIR(0u) | LPSPI_CFGR0_HREN(0u) |
        ...
        (uint32)(LPSPI_CCR_SCKPCS(1U) | LPSPI_CCR_PCSSCK(1U) | LPSPI_CCR_SCKDIV(10U) | LPSPI_CCR_DBT(3U)), /* ccr */
...
/* SPI controller SpiPhyUnit_FS23 configuration. */
const Lpspi_Ip_ConfigType Lpspi_Ip_PhyUnitConfig_SpiPhyUnit_FS23_Instance_0_VS_0 =
{
    0U,  /* Instance */
     /* CR */
    (uint32)0,
