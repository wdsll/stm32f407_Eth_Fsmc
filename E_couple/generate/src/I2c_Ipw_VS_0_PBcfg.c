...
#define I2C_IPW_VS_0_PBCFG_SW_MAJOR_VERSION_C              4
...
#if (I2C_IPW_VS_0_PBCFG_VENDOR_ID_C != I2C_IPW_TYPES_VENDOR_ID)
    #error "I2c_Ipw_VS_0_PBcfg.c and I2c_Ipw_Types.h have different vendor ids"
#endif

/* Check if current file and I2c header file are of the same vendor */
#if (I2C_IPW_VS_0_PBCFG_MODULE_ID_C   != I2C_IPW_TYPES_MODULE_ID)
    #error "I2c_Ipw_VS_0_PBcfg.c and I2c_Ipw_Types.h have different module ids"
#endif
/* Check if current file and I2c header file are of the same Autosar version */
#if ((I2C_IPW_VS_0_PBCFG_AR_RELEASE_MAJOR_VERSION_C != I2C_IPW_TYPES_AR_RELEASE_MAJOR_VERSION) || \
     (I2C_IPW_VS_0_PBCFG_AR_RELEASE_MINOR_VERSION_C != I2C_IPW_TYPES_AR_RELEASE_MINOR_VERSION) || \
     (I2C_IPW_VS_0_PBCFG_AR_RELEASE_REVISION_VERSION_C != I2C_IPW_TYPES_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of I2c_Ipw_VS_0_PBcfg.c and I2c_Ipw_Types.h are different"
#endif
/* Check if current file and I2c header file are of the same Software version */
#if ((I2C_IPW_VS_0_PBCFG_SW_MAJOR_VERSION_C  != I2C_IPW_TYPES_SW_MAJOR_VERSION) || \
     (I2C_IPW_VS_0_PBCFG_SW_MINOR_VERSION_C  != I2C_IPW_TYPES_SW_MINOR_VERSION) || \
     (I2C_IPW_VS_0_PBCFG_SW_PATCH_VERSION_C  != I2C_IPW_TYPES_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of I2c_Ipw_VS_0_PBcfg.c and I2c_Ipw_Types.h are different"
#endif
