...
*
*/
#define DioConf_DioChannel_Rst  ((uint16)0x0005U)
/* ---------- DioPort_1 ---------- */
...
/**
* @brief          Symbolic name for the channel PTB2.
*
*/
#define DioConf_DioChannel_PTB2  ((uint16)0x0022U)
/**
* @brief          Symbolic name for the channel PTB3.
*
*/
#define DioConf_DioChannel_PTB3  ((uint16)0x0023U)
/**
* @brief          Symbolic name for the channel PTB5.
*
*/
#define DioConf_DioChannel_PTB5  ((uint16)0x0025U)
/**
* @brief          Symbolic name for the channel PTB8.
*
*/
#define DioConf_DioChannel_PTB8  ((uint16)0x0028U)
/* ---------- DioPort_2 ---------- */

/**
* @brief          Symbolic name for the port DioPort_2.
*/
#define DioConf_DioPort_DioPort_2  ((uint8)0x06U)
/**
* @brief          Symbolic name for the channel PTD11.
*
*/
#define DioConf_DioChannel_PTD11  ((uint16)0x006bU)
/**
* @brief          Symbolic name for the channel PTD10.
*
*/
#define DioConf_DioChannel_PTD10  ((uint16)0x006aU)
/**
* @brief          Symbolic name for the channel PTD12.
*
*/
#define DioConf_DioChannel_PTD12  ((uint16)0x006cU)
/**
* @brief          Symbolic name for the channel PTD13.
*
*/
#define DioConf_DioChannel_PTD13  ((uint16)0x006dU)
/**
* @brief          Symbolic name for the channel PTD14.
*
*/
#define DioConf_DioChannel_PTD14  ((uint16)0x006eU)
