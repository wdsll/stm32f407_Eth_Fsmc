...
*/
#define SpiConf_SpiChannel_SpiChannel_FS23    ((Spi_ChannelType)0U)
...
*     for all the driver configurations.
*/
#define SpiConf_SpiJob_SpiJob_FS23    ((Spi_JobType)0U)
...
*     for all the driver configurations.
*/
#define SpiConf_SpiSequence_SpiSequence_FS23    ((Spi_SequenceType)0U)
