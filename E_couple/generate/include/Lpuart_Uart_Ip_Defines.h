...
#define LPUART_UART_IP_TIMEOUT_VALUE_US         (65535)
...
#define LPUART_UART_IP_ENABLE_TIMEOUT_INTERRUPT  (STD_ON)
    ...
    #define LPUART_UART_IP_ENABLE_TIMEOUT_INTERRUPT_PER_INSTANCE  {(boolean) FALSE, (boolean) FALSE, (boolean) FALSE, (boolean) TRUE}
#endif
...
#define LPUART_UART_IP_ENABLE_INTERNAL_LOOPBACK  (STD_OFF)
    ...
    /* @brief Array of instances that have loopback mode enabled. */
    #define LPUART_UART_IP_ENABLE_INTERNAL_LOOPBACK_PER_INSTANCE  {(boolean) FALSE, (boolean) FALSE, (boolean) FALSE, (boolean) FALSE}
#endif
