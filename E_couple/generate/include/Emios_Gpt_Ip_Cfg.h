...
/* Check if  header file and Emios_Gpt_Ip_VS_0_PBcfg.h file are of the same Autosar version */
...
/* Check if header file and Emios_Gpt_Ip_VS_0_PBcfg.h file are of the same Software version */
