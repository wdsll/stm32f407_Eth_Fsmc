...
#define SIUL2_ICU_IP_SW_MAJOR_VERSION_C            4
...
SIUL2_Type * const Siul2_Icu_Ip_pBase[][SIUL2_ICU_IP_NUM_PDAC_SLOT] = SIUL2_ICU_IP_BASE_PTRS;
#else
/* Table of base addresses for SUIL2 instances. */
...
uint8 Siul2_Icu_Ip_InterruptPdacSlot[SIUL2_ICU_IP_NUM_OF_INSTANCES];
#endif
...
#if(SIUL2_ICU_IP_VIRTWRAPPER_SUPPORT == STD_ON)
    base = Siul2_Icu_Ip_pBase[instance][Siul2_Icu_Ip_InterruptPdacSlot[instance]];
#else
...
#if(SIUL2_ICU_IP_VIRTWRAPPER_SUPPORT == STD_ON)
    Siul2_Icu_Ip_InterruptPdacSlot[instance] = 0;
#endif
...
#if(SIUL2_ICU_IP_VIRTWRAPPER_SUPPORT == STD_ON)
    Siul2_Icu_Ip_InterruptPdacSlot[instance] = userConfig->interruptPdacSlot;
#endif
