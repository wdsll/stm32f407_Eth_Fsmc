...
#define SIUL2_ICU_IP_SW_MAJOR_VERSION             4
...
extern SIUL2_Type * const Siul2_Icu_Ip_pBase[][SIUL2_ICU_IP_NUM_PDAC_SLOT];
#else
...
#if (SIUL2_ICU_IP_VIRTWRAPPER_SUPPORT == STD_ON)
extern uint8 Siul2_Icu_Ip_InterruptPdacSlot[SIUL2_ICU_IP_NUM_OF_INSTANCES];
#endif
