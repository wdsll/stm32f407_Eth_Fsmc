...
#define AD7190_GPIO_CLK_ENABLE()   __HAL_RCC_GPIOB_CLK_ENABLE()
#define AD7190_CS_Pin              GPIO_PIN_14
#define AD7190_CS_GPIO_Port        GPIOB
#define AD7190_SCK_Pin             GPIO_PIN_3
