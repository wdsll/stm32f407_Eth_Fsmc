...
/* ===== 37/38/39V 临时测试版 =====
 * 这几个点的母线目标统一按 41*9 = 369V
 * 目的：先验证降低母线后，LLC 是否更接近谐振点，从而减轻输出坍陷
 */
#define PFC_VBUS_TARGET_TEST_V        (369.0f)
/* ===== 三态机：门限/时序 ===== */
#define PFC_STARTUP_DELAY_MS          (1000U)

/* READY判定：369V ± 10V */
#define PFC_VBUS_READY_V              (369.0f)
...
#define PFC_VBUS_DROPOUT_THRESHOLD_V  (345.0f)
